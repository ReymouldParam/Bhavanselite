...
// Animate hero section text on page load

document.addEventListener('DOMContentLoaded', function () {
    var heroText = document.querySelector('.hero-text');
    var heroHighlight = document.getElementById('dynamic-word');
    if (heroText) heroText.classList.add('hero-text-animate');
    if (heroHighlight) heroHighlight.classList.add('hero-highlight-animate');
});